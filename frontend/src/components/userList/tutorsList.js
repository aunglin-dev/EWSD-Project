  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const tutorsResponse = await axiosInstance.get(
      ...
      >
        <Box>
          ...
          <Typography variant="subtitle1">
            View all personal tutor information
          </Typography>
        </Box>
      </Box>
      ...
      <Box>
        ...
        {loading ? (
          ...
          <TableContainer sx={{ mt: "50px", bgcolor: "#fff" }}>
            <Table
              sx={{ minWidth: 650, border: "2px solid #0A1F44" }}
            ...
            >
              ...
              <TableBody>
                <TableRow sx={{ borderBottom: "2px solid #0A1F44" }}>
                  <TableCell>{selectedTutor.name}</TableCell>
                  <TableCell>{selectedTutor.email}</TableCell>
                  <TableCell>
                    {allocations.filter(
            ...
            >
              ...
              <TableBody>
                {tutors.map((tutor) => (
                  <TableRow
                    key={tutor._id}
                    sx={{ borderBottom: "2px solid #0A1F44" }}
                  >
